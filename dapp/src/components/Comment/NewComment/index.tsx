...
import { ReviewAttachments, Reviews } from '@generated/reviewtypes'
import {
...
const NewComment: FC<Props> = ({ post, type, url }) => {
  ...
  const [attachments, setAttachments] = useState<ReviewAttachments[]>([])
